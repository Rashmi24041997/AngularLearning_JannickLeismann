...
export class CitiesService {
  ...
  public putCity(city: City): Observable<City> {
    ...
    return this.httpClient.put<City>(`${API_BASE_URL}/${city.cityID}`, city, { headers: this.headers })
  }

  public deleteCity(cityID: string | null|undefined): Observable<string> {

    return this.httpClient.delete<string>(`${API_BASE_URL}/${cityID}`, { headers: this.headers })
  }
