...
export class CitiesComponent {
        ...
        this.putCityFormArray.push(new FormGroup(
            {
              ...
              cityName: new FormControl(
                { value: response.cityName, disabled: true }, [Validators.required]
              )
            }
          )
        )
  ...
  editClicked(city: City): void {
    this.editCityID = city.cityID == "" || city.cityID == null ? "" : city.cityID;
  }
  ...
  deleteClicked(city: City, i: number) {
    ...
    if (confirm(`Are you sure to delete ${city.cityName} city?`)) {
